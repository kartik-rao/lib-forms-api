...
CREATE TABLE IF NOT EXISTS Plan (
    ...
    startDate VARCHAR(27) NOT NULL,
    endDate VARCHAR(27),
    active TINYINT,
    lastBillDate VARCHAR(27),
    createdAt VARCHAR(27) NOT NULL,
    updatedAt VARCHAR(27),
    isDeleted TINYINT DEFAULT 0,
...
DROP TABLE IF EXISTS AccountIntegration;
CREATE TABLE IF NOT EXISTS AccountIntegration (
    id VARCHAR(36) NOT NULL,
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (accountId) REFERENCES Account(id),
    UNIQUE INDEX `INDX_AccountIntegration_accountId` (`accountId` ASC)
);
